...
const newPerson = Object.assign({}, person, {name: 'Tim', age: 24});
...
const superHeroes = ['Batman', 'Superman', 'Deadpool for some reason'];
const superVillains = ['Joker', 'Lex Luthor', 'Deadpool again because I can'];
...
for (let i = 1; i <= 50; ++i) {
  studentScores.scores.push(i);
}

const studentAverage = Object.assign({}, studentScores, {scores: studentScores.scores.filter(number => number >= 34)});
